...
import {RegisterPage, FormikBasicPage, FormikYupPage, FormikComponents, FormikAbstract, RegisterFormikPage, DynamicFormPage } from '../03-forms/pages'; //barrell tecnica
